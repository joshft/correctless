...
> **Note:** This is the original design specification. The implementation has evolved — 9 skills were added (/cdevadv, /credteam, /cstatus, /csummary, /cmetrics, /cdebug, /creview, /cpr-review, /crefactor), the bounty/penalty economics were refined, and several feedback loops were closed. Full now has 19 skills. See the [README](README.md) and the actual [skill files](skills/) for the current implementation.
