...
- **Test**: `tests/test-fix-diff-reviewer-agent.sh`, `tests/test-carchitect.sh`, `tests/test-carchitect-phase4.sh`, `tests/test-ctdd-green-agent.sh`, `tests/test-creview-spec-agents.sh`
