...
| Tests | `tests/test*.sh` | 48 test files (~3,900 shell tests) covering all hooks, scripts, skills, agents, Phase 2 components, Phase 3 components, test-evasion antipattern validation, and scanner expansion (grep portability + dead-security-fn detection) |
...
| Run auto pipeline | `/cauto` (after spec review approved) |
